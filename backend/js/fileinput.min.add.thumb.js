 ...
 */
 var before_src = $("#the_certificate_img").attr("src");
 var uploaded_image_selected_once = false;
 function make_certificate_items_returns_to_original(){
	 $(".cert-drag").animate({top:0,left:0},1500);
 }
(function (e) {
    ...
    l.prototype = {constructor: l, listen: function () {
		...
		$("#the_certificate_img").attr("src",before_src);
		if(uploaded_image_selected_once)make_certificate_items_returns_to_original();
                ...
                if (o.length > 0 && (v == "any" ? n || r : v == "text" ? r : n) && typeof FileReader !== "undefined") {
                    ...
                    i.onload = function (e) {
                        ...
                        if (r) {
							...
							$("#the_certificate_img").attr("src",e.target.result);
							make_certificate_items_returns_to_original();
							uploaded_image_selected_once = true;
                        }
                        o.append("\n" + n);
                        if (b >= y - 1) {
